...
-- Table `ninak`.`User`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ninak`.`User` ;
...
-- Table `ninak`.`Account`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ninak`.`Account` ;
...
-- Table `ninak`.`Teacher`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ninak`.`Teacher` ;
...
-- Table `ninak`.`Student`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ninak`.`Student` ;
...
-- Table `ninak`.`Course`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ninak`.`Course` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ninak`.`Institute` ;
